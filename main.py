...
async def main():
    ...
    try:
        ...
        parser.add_argument('--mode', choices=['daily_full', 'incremental', 'status_update',
                            'weekly_catchup', 'order_details', 'shipment_update', 'inventory_activate', 'inventory_deactivate', 'inventory_friday', 'inventory_monday', 'product_verification', 'price_analysis', 'price_analysis_priority'], required=True)
